...
# 🦁 XXD Panel 086｜دفتر المطبوعات بالفراغ
...
تبقى `sample-01`–`sample-04` محجوزة لنماذج الإصدار الأصلية القابلة للتحقق. تضم الأعمال الثمانية أعلاه أربعة نماذج أفقية 16:9 بتكوين يسار–يمين وأربعة نماذج رأسية 3:4 بتكوين أعلى–أسفل. ولّد Panel 086 كل عمل بصورة مستقلة وفق موجّهه الأصلي، من دون إعادة استخدام أعمال أي Panel آخر. تستخدم النماذج نصاً إنجليزياً مولّداً بذكاء.

<!-- xxd-human-intro:start -->
## ما الذي يحله هذا الأسلوب؟

تُبقي المرشحات الميكانيكية عناصر أكثر من اللازم، بينما تملأ القوالب القديمة الصفحة بالزخرفة فتفقد البؤرة والاتجاه والفراغ ذي المعنى.

يختزل **Panel 086** الصورة إلى 3–5 معلومات بصرية حاسمة، ثم يعيد بناءها كطباعة حريرية محدودة الألوان بروح حداثة منتصف القرن، باستخدام الظلال والأشكال الهندسية والبقع اللونية البسيطة. وتحافظ 2–4 ألوان خاصة، والفرشاة الجافة، وملمس الأسطوانة، وسحب الحبر وانقطاعه وتغطيته غير المتساوية على خشونة الطباعة.

### مناسب لـ

- اختزال الصورة إلى 3–5 معلومات حاسمة وتكوين طباعي قوي يُقرأ من بعيد؛
- تكثيف المعنى عبر الظلال والهندسة والبقع المحدودة والفراغ الواسع؛
- الحصول على ملمس حبر خشن يضم الفرشاة الجافة والسحب الأفقي والفراغات وانقطاع الحبر؛
- مخرجات أعلى–أسفل ويسار–يمين وتصميم فقط ونسب متعددة وحزم خلفيات ومعالجة المجلدات.

### بداية سريعة

> استخدم XXD Panel 086 لمعالجة هذه الصورة واقترح أولاً أنسب تكوين وحجم.
...
**البصمة:** حداثة منتصف القرن · طباعة حريرية محدودة الحبر · هندسة الظلال · سحب الفرشاة الجافة · انقطاع الحبر والفراغات · فراغ ذو معنى
...
|---|---|
| **الناتج** | ملصق طباعي يقرأ الفراغ والنسبة والبؤرة أولاً، ثم يكشف خشونة الحبر عند الاقتراب |
| **البصمة الواضحة** | 3–5 معلومات أساسية، ظلال وأشكال هندسية، 2–4 ألوان خاصة، وحبر مسحوب ومنقطع |
| **احترام المصدر** | يقرأ الموضوع والمحيط والوضع والاتجاه والعلاقات، ولا يحتفظ إلا بما يجعل الصورة متماسكة |
...
```text
تحليل الموضوع والمحيط والوضع والاتجاه والبؤرة → الاحتفاظ بـ3–5 معلومات حاسمة → إعادة البناء بالظلال والهندسة والبقع اللونية → ضغط اللون إلى 2–4 ألوان خاصة → إضافة الفرشاة الجافة والسحب والفراغات وانقطاع الحبر → ترتيب لا تماثلي حول بؤرة واتجاه وفراغ ذي معنى
```

## سمات النتيجة النهائية

- يظهر الموضوع بظلال وأشكال هندسية وبقع بسيطة، ولا يبقى من البيئة إلا القليل الذي يخدم السرد.
- تبقى آثار السحب الأفقي والفراغات وانقطاع الحبر والتغطية غير المتساوية، مع رفض المتجهات الناعمة والتدرجات الرقمية.
- تُضغط ألوان الصورة إلى 2–4 ألوان خاصة فوق أساس قريب من الورق.
- تبقى بؤرة واضحة واتجاه رئيسي واحد وفراغ واسع يحمل المعنى.
- يتبع النص قواعد الموجّه الأصلي: قليل، ضيق ومتحفظ، ومصطف مع الفراغ والمحور البصري.

توجد القيود الجمالية فقط في [الموجّه الأصلي](references/original-prompt/zh-CN.md). يعالج الـ Skill ومهايئات التشغيل متغيرات التسليم فقط. [Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-086-prompt.en.md)
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 086. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-086 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-086 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-086 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-086 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-086 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 086 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-086 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-086`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-086-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-086-prompt.zh-CN.md)

<!-- xxd-panel-catalog:start -->
## دليل مشاريع XXD Panel الكامل

يحافظ كل مشروع من مشاريع Panel الـ86 على موجّهه الأصلي ومنطقه الجمالي المستقل. يسرد الجدول المشاريع من 001 إلى 086 دون أرقام مفقودة، مع تمييز المشروع الحالي بخط عريض.
...
| **الجنود** | `xxd-panel-NNN` (حالياً 001–086) | تنفذ كل مهارة مرقمة موجّهها الأصلي وجماليتها الخاصة فقط، وتنجز المهمة الفردية التي يرسلها الجنرال. |
