...
```text
/xxd-panel-086 <source-or-directory> --mode top-bottom,design-only \
...
1. 上下对照（原图在上，086 设计在下）
2. 左右对照（原图在左，086 设计在右）
...
```text
~/Desktop/xxd/xxd-panel-086/<fresh-task>/
...
- `references/xxd-panel-086-prompt.zh-CN.md`
- `references/xxd-panel-086-prompt.en.md`
